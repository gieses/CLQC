...
if __name__ == "__main__":
    ...
    parser.add_argument('--max_distance', metavar='max_distance', type=float,
                        ...
                        default=25.0)
    parser.add_argument('--addrandom', metavar='addrandom', type=bool,
                        help='Add a random reference distribution? (Yes|No)',
                        default=True)
...
-------------------------------------------"""
    ...
    print "AddRandom: {}".format(addrandom)
    print ""
...
-------------------------------------------"""
    ...
    for links_file in links_in:
        ...
        report.Create_Distogram(chain=args.chain, overlength=maxdist,
                                addRandom=args.addrandom,
                                output=out_path+protname+str(counter).zfill(2),
                                proteinname=args.protname)
        counter += 1
